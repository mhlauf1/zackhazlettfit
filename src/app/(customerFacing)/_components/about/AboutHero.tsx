        ...
        <div className="relative flex h-auto lg:px-20 px-4 flex-col gap-y-16 pb-10 md:pb-24 pt-4 md:pt-28 md:flex-row md:items-center md:py-24">
          <div className="flex w-full justify-between  flex-col items-start md:w-7/12 ">
            <div className="flex mt-8 md:mt-12 flex-col items-start">
              ...
              <h1 className="mb-4 mt-6 md:mt-10 w-full text-3xl font-semibold tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-neutral-900 to-neutral-700 md:text-5xl lg:text-6xl">
          ...
          <div className="md:w-5/12">
            <div className="flex md:h-[70vh] md:mb-0 w-full items-start rounded-xl">
              <ReactPlayer
                playing
                loop
                playsinline
